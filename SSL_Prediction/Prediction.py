...
def prediction():
    ...
    # actions = np.array(['oba', 'kavda', 'name']) # Actions that we try to detect
    actions = np.array(['deaf and mute', 'population', 'in srilanka']) # Actions that we try to detect
    ...
    # model.load_weights('D:/Final Year/chatbot/SSL_Prediction/action1.h5')
    model.load_weights('D:/Final Year/chatbot/SSL_Prediction/actionpopulation.h5')
    # model.load_weights('D:/Final Year/chatbot/SSL_Prediction/actionfinal.h5')
